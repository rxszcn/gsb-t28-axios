...
class AxiosHeaders {
  ...
  set(header, valueOrRewrite, rewrite) {
    ...
    function setHeader(_value, _header, _rewrite) {
      ...
      // An own key holding `undefined` is an explicit "cleared" marker, not an
      // absent header: a non-forced rewrite (`_rewrite === false`, e.g. a
      // default Content-Type) must not fill it back in. Only a missing key,
      // a forced rewrite, or a plain set over a non-`false` value may write.
